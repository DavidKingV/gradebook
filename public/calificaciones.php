...
<html lang="es">
    ...
    <body class="d-flex flex-column h-100 bg-light">
        <main class="flex-shrink-0">
            ...
            <div class="container px-5 my-5">
                <div class="text-center mb-5">
                    <h1 class="display-5 fw-bolder mb-0"><span class="text-gradient d-inline">Calificaciones</span></h1>
                </div>
                                ...
                                <div class="card-body p-5">
                                    <div class="row align-items-center gx-5">
                                        ...
                                        <table class="table" id="subjects">
                                            <thead>
                                              <tr>
                                                <th scope="col" class="text-center">Todo <input class="form-check-input" type="checkbox" value="" id="selectAll"></th>
                                                <th scope="col" class="text-center">ID</th>
                                                <th scope="col" class="text-center">Materia</th>
                                                <th scope="col" class="text-center">Cal. Continua</th>
        ...
        <!-- Core theme JS-->
        <script type="module" src="js/pages/calificaciones.js"></script>
